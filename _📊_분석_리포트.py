...
# 지도-업종
file_name = 'data/rawdata_folium_1022_1.csv'
...
file_name = "data/mini_sample.csv"
df_mini = load_data(file_name,"utf-8")

# 거주인구 (이미 전처리 완료된 데이터셋)
file_name = "data/df_melt.csv"
...
# geo_data = requests.get("data/서울_자치구_경계_2017.geojson").json()
geo_data = geojson.load(open('data/서울_자치구_경계_2017.geojson', encoding='UTF-8'))
